...
const INTEL='geiProjectResearchDecisionExecutionIntelligenceV680';
const EXEC='geiProjectResearchExecutionV623';
const KEY='geiProjectResearchDecisionExecutionOutcomeV681';
...
function save(a){
 ...
 if(!a.ready){alert('V6.81 is not ready. A V6.79 handoff must be READY FOR EXECUTION and all documented V6.23 tasks must be COMPLETE.');return;}
 const rec={
  ...
  lineage:'V6.69 → V6.70 → V6.71 → V6.72 → V6.73 → V6.23 → V6.74 → V6.75 → V6.76 → V6.77 → V6.78 → V6.79 → V6.80 → V6.81'
 };
